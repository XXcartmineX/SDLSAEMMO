...
fVector2 fVector2::Projection(const fVector2 & p2)
{
	fVector2 p2cpy(p2);
	float dot = this->Dot(p2)/p2cpy.Dot(p2);
	return fVector2(dot*p2.x,dot*p2.y);
}
...
fVector2 & fVector2::operator=(const b2Vec2& rhs)
{
	this->x = rhs.x;
	this->y = rhs.y;
	return *this;
...
struct b2Vec2 fVector2::tobVec2()
{
